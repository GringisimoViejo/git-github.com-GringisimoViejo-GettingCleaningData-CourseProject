## The installation of the Dplyr package is necessary for this script to run properly
...
## just features. Only one column of features is needed so the other columns is stripped
## out. 
